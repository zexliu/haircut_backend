...
public class OmShopOrderController {
    ...
    @GetMapping
    public IPage<OmShopOrder> shopOrder(Pageable pageable, String keywords, Long shopId, Long stylistId,Long userId, ShopOrderStatus status, SexType sexType, LocalDateTime startAt, LocalDateTime endAt) {
        return iOmShopOrderService.page(pageable.convert(), new LambdaQueryWrapper<OmShopOrder>()
                ...
                .eq(sexType != null, OmShopOrder::getSexType, sexType)
