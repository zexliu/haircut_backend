 ...
 * 执行main函数即可体验短信产品API功能(只需要将AK替换成开通了短信产品功能的AK即可)
 * 工程依赖了2个jar包(存放在工程的libs目录下)
 * 1:aliyun-java-sdk-core.jar
 * 2:aliyun-java-sdk-dysmsapi.jar
 *
 * 备注:Demo工程编码采用UTF-8
 * 需要修改的配置：accessKeyId，accessKeySecret，setPhoneNumbers，setSignName，setTemplateCode，setTemplateParam
 */
public class SmsUtils {
    ...
    public static SendSmsResponse sendSms() throws ClientException {
        ...
        request.setPhoneNumbers("18713888898");
        //必填:短信签名-可在短信控制台中找到
        request.setSignName("亿店圈");
        //必填:短信模板-可在短信控制台中找到
        request.setTemplateCode("501");
