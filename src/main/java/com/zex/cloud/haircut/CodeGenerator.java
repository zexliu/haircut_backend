...
public class CodeGenerator {
    ...
    public static final String DATA_SOURCE_URL = "jdbc:mysql://localhost:3306/haircut?useUnicode=true&useSSL=false&characterEncoding=utf8";
